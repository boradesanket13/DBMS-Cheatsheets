...
`db.collection.insertOne({name: 'John Deo', ip: '127.0.0.1', lastLoginTime: 1575704736})`;
...
`db.collection.insertMany([{name: 'John Deo', ip: '127.0.0.1', lastLoginTime: 1575704736}, {name: 'John Doe', ip: '10.10.10.10', lastLoginTime: 1575704965}])`;
...
`db.collection.find({name: 'John Deo'})`
